...
<div id="content" class="static_page">
	...
	<div class="row-fluid">		
		<h3><?php echo $heading_title; ?><span class="pull-right button_read"><a href="<?php echo $news_link;?>">&raquo; <?php echo $text_link;?></a></span></h3> 
		...
		<div class="container col-xs-12 col-sm-12 col-md-12 text-center">
